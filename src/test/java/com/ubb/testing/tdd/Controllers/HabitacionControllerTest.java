...
public class HabitacionControllerTest {
	...
	void siSeInvocaSaveHabitacionDebeRetornarLaHabitacionObtenida() throws Exception {
		...
		MockHttpServletResponse response = mockMvc.perform(post("/habitaciones/save")
				.contentType(MediaType.APPLICATION_JSON).content(jsonHabitacion.write(habitacionCreate).getJson()))
